                    ...
                    <div>
                        <button type="submit"
                            class="py-3 px-5 w-full text-sm font-medium text-center text-white rounded-lg border cursor-pointer
                             bg-primary-700 border-primary-600 sm:rounded-none sm:rounded-r-lg
                    ...
                    <div class="flex justify-between items-center mb-5 text-gray-500">
                        <span
                            ...
                            <a href="/categories/{{ $post->category->slug }}"
                                class="text-base hover:underline">{{ $post->category->name }}</a>
                        </span>
                    ...
                    <div class="flex justify-between items-center">
                        <div class="flex items-center space-x-3">
                            ...
                            <span class="font-medium text-sm dark:text-white">
                                <a href="/authors/{{ $post->author->username }}" class="text-gray-500 hover:underline">
                                    {{ $post->author->name }}
                                </a>
                            </span>
                        </div>
